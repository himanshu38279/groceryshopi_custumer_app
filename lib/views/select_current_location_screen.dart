...
class SelectCurrentLocation extends StatefulWidget {
  static const id = 'select_current_location';

  @override
  _SelectCurrentLocationState createState() => _SelectCurrentLocationState();
}
                ...
                children: [
                  ...
                  ListView.separated(
                    ...
                    itemBuilder: (ctx, index) {
                      return InkWell(
                          onTap: () async {
                            print(addressList.elementAt(index).addressId);
                            final res = await displayPrediction(
                                addressList.elementAt(index).addressId);
                            print(res.longitude);
                            print(res.latitude);
                            locationController.setCurrentLocation(
